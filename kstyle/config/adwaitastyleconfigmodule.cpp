...
#include "adwaitastyleconfigmodule.h"

#include <KPluginFactory>


K_PLUGIN_FACTORY(
    AdwaitaStyleConfigFactory,
    registerPlugin<Adwaita::ConfigurationModule>(QStringLiteral("kcmodule"));
)

#include "adwaitastyleconfigmodule.moc"
