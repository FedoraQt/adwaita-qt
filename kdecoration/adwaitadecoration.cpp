...
#include "adwaitadecoration.h"

#include "adwaita.h"
#include "adwaitasettingsprovider.h"
#include "config-adwaita.h"
#include "config/adwaitaconfigwidget.h"

#include "adwaitabutton.h"
#include "adwaitasizegrip.h"
...
K_PLUGIN_FACTORY_WITH_JSON(
    AdwaitaDecoFactory,
    "adwaita.json",
    registerPlugin<Adwaita::Decoration>();
    registerPlugin<Adwaita::Button>(QStringLiteral("button"));
    registerPlugin<Adwaita::ConfigWidget>(QStringLiteral("kcmodule"));
)
