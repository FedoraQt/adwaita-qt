...
#ifndef ADWAITA_HEADER_VIEW_ENGINE_H
#define ADWAITA_HEADER_VIEW_ENGINE_H
...
class ADWAITAQT_EXPORT HeaderViewEngine : public BaseEngine
{
    Q_OBJECT
public:
    //* constructor
...
#endif // ADWAITA_HEADER_VIEW_ENGINE_H
